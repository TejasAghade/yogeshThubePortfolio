                    ...
                    <div className="industry-support-card-wr flex flex-row p-5 pt-4 justify-between rounded-md bg-white">
                        <div className="card h-full w-96 p-4">
                            <div className="i-image">
                                <img src="src/assets/i1.webp" className='rounded-md' alt="" />
                            </div>
                        ...
                        <div className="card h-full w-96 p-4">
                            <div className="i-image">
                                <img src="src/assets/i2.webp" className='rounded-md' alt="" />
                            </div>
                            <div className="body mt-5">
                                <div className="tit">
                        ...
                        <div className="card h-full w-96 p-4">
                            <div className="i-image">
                                <img src="src/assets/i3.webp" className='rounded-md' alt="" />
                            </div>
                            <div className="body mt-5">
                                <div className="tit">
